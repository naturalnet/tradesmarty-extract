...
const D = {
fca: {
terms: `${BASE}/utils/pdf/start-trading/documents/terms-of-securities-trading.pdf?regulator=fca`,
risk: `${BASE}/start-trading/documents/product-information-docs/risk-disclosure?regulator=fca`,
center: `${BASE}/start-trading/documents`,
open: `${BASE}/start-trading`,
svc: `${BASE}/?regulator=fca`
},
cysec: {
terms: `${BASE}/start-trading/documents`,
risk: `${BASE}/risk-disclosure`,
center: `${BASE}/start-trading/documents`,
open: `${BASE}/start-trading`,
svc: `${BASE}/`
},
asic: {
terms: `${BASE}/utils/pdf/start-trading/documents/account-terms.pdf`,
risk: `${BASE}/utils/pdf/start-trading/documents/product-disclosure.pdf`,
center: `${BASE}/start-trading/documents`,
open: `${BASE}/start-trading`,
svc: `${BASE}/`
},
fsca: { terms: `${BASE}/start-trading/documents`, risk: `${BASE}/risk-disclosure`, center:`${BASE}/start-trading/documents`, open:`${BASE}/start-trading`, svc:`${BASE}/?regulator=fsca` },
jsc: { terms:`${BASE}/utils/pdf/start-trading/documents/terms-and-conditions.pdf?regulator=jsc`, risk:`${BASE}/utils/pdf/start-trading/documents/securities-trading-risk-disclosure.pdf?regulator=jsc`, center:`${BASE}/start-trading/documents`, open:`${BASE}/start-trading`, svc:`${BASE}/?regulator=jsc` },
cma: { terms:`${BASE}/start-trading/documents`, risk:`${BASE}/risk-disclosure`, center:`${BASE}/start-trading/documents`, open:`${BASE}/start-trading`, svc:`${BASE}/` },
fsa: { terms:`${BASE}/start-trading/documents`, risk:`${BASE}/risk-disclosure`, center:`${BASE}/start-trading/documents`, open:`${BASE}/start-trading`, svc:`${BASE}/education/faq/regulation` }
};
return D[reg];
}


async function validateLinks(o) {
...
// attach docs & validate
for (const e of entities) {
const d = docsFor(e.key);
await validateLinks(d);
e.docs = d;
}
